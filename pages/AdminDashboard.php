            ...
            <div class="container-fluid px-0 mt-3">
                <div class="row mx-3 p-2 d-flex">
                    ...
                    <div class="col d-flex justify-content-end align-items-end gap-2">
                        <button class="btn btn-outline-secondary"><small>Print</small><i
                    ...
                    <div class="row">
                        ...
                        <div class="col stat d-flex stat border shadow-lg p-4">
                            ...
                            <div class="w-100">
                                ...
                                <p class="display-6 fw-bold font-monospace text-center"><?php echo $row["unit_sold"]?>
                                </p>
                            </div>
                        </div>
                ...
                <div class="row mx-5 my-5 rounded border pt-5">
                    ...
                    <div class="row">
                        <div class="col d-flex border-bottom">
                            <button class="btn btn-outline-secondary border active" data-section="chart-1">Sales
                                Trends</button>
...
JOIN products p on o.PID = p.PID GROUP by p.product_name;");
        ...
        ?>
                ...
                <div class="row mx-5 my-5 rounded border">
                                        ...
                                        <div class="search-container position-relative">
                                            <form class="d-flex align-items-center" method="GET" action="">
                                                ...
                                                <input class="form-control search-input ps-5" type="search"
                                                    name="search" placeholder="Search product..." aria-label="Search"
                    ...
                    <div
                        class="row mx-0 table-section my-5 p-0 d-flex justify-content-center align-items-center text-center">
